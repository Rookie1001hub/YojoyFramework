...
namespace Sirenix.Utilities.Editor.Expressions
{
    ...
    public class Tokenizer
    {
        ...
        private int expresssionStringPosition;
        private string expressionString;

        public string ExpressionString { get { return this.expressionString; } }
        public int ExpressionStringPosition { get { return this.expresssionStringPosition; } }
        ...
        {
            this.expresssionStringPosition = state.TokenStringPosition;
        ...
        public void SetExpressionString(string expressionString)
        {
            ...
            this.expresssionStringPosition = 0;
        ...
        public Token GetNextToken()
        {
            ...
            var tempPos = this.expresssionStringPosition;
            ...
            switch (nextCharacter)
            {
                ...
                default:
                    ...
                    throw new SyntaxException(this, "Unknown token '" + nextCharacter + "' at position " + (this.expresssionStringPosition - 1)); // TODO: Line number?
            }
        }
        ...
        {
            if (this.expresssionStringPosition == this.expressionString.Length)
            {
                return NoMoreCharacters;
            }
            return this.expressionString[this.expresssionStringPosition++];
        }

        private char PeekNextCharacter(int offset = 0)
        {
            if ((this.expresssionStringPosition + offset) >= this.expressionString.Length)
            {
                return NoMoreCharacters;
            }
            return this.expressionString[this.expresssionStringPosition + offset];
        }
