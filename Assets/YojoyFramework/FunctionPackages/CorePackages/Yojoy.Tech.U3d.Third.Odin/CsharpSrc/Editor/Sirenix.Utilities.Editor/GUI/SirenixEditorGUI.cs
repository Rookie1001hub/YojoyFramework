...
#pragma warning restore 0618 // Type or member is obsolete
        ...
        public static string SearchField(Rect rect, string searchText, bool forceFocus = false, string controlName = "SirenixSearchField")
        {
            ...
            var tmpText = EditorGUI.TextField(rect, searchText, SirenixGUIStyles.ToolbarSeachTextField);
            ...
            {
                GUI.Label(rect.Padding(14, -1, -4, 0), GUIHelper.TempContent("Search"), SirenixGUIStyles.LeftAlignedGreyMiniLabel);
            }
