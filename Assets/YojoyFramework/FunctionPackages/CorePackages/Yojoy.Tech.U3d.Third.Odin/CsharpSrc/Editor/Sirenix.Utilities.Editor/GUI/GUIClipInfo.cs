...
namespace Sirenix.Utilities.Editor
{
    ...
    public static class GUIClipInfo
    {
        ...
        private static Func<Vector2, Vector2> unclipVectorGetter = (Func<Vector2, Vector2>)Delegate.CreateDelegate(typeof(Func<Vector2, Vector2>), GUIClipType
            .FindMember()
            .IsMethod()
            .HasReturnType<Vector2>()
            .HasParameters<Vector2>()
            .GetMember<MethodInfo>());

        private static Func<Rect, Rect> unclipRectGetter = (Func<Rect, Rect>)Delegate.CreateDelegate(typeof(Func<Rect, Rect>), GUIClipType
            .FindMember()
            .IsMethod()
            .HasReturnType<Rect>()
            .HasParameters<Rect>()
        ...
        private static Func<Rect> getTopRectGetter = (Func<Rect>)Delegate.CreateDelegate(typeof(Func<Rect>), GUIClipType
            .FindMember()
            .IsMethod()
            .HasNoParameters()
            .HasReturnType<Rect>()
