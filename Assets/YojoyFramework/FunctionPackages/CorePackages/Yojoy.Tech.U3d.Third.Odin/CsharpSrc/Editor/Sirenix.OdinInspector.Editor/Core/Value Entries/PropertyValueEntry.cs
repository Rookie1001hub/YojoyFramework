...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public abstract class PropertyValueEntry : IPropertyValueEntry
    {
        ...
        /// </summary>
        [Obsolete("The core property system no longer has custom hard-coded collection support.", true)]
        ...
        public virtual PropertyValueCategory ValueCategory { get { throw new NotSupportedException(); } }
        ...
        /// </summary>
        [Obsolete("Use property.ChildResolver as IOrderedCollectionResolver instead.", true)]
        public PropertyListValueEntryChanger GetListValueEntryChanger()
        {
        ...
        /// </summary>
        [Obsolete("Use property.ChildResolver as IKeyValueMapResolver instead.", true)]
        public IDictionaryHandler GetDictionaryHandler()
        {
            throw new NotSupportedException();
        }
        ...
        internal static PropertyValueEntry Create(InspectorProperty property, Type valueType, bool isSecretRoot)
        {
            ...
            PropertyValueEntry result = (PropertyValueEntry)Activator.CreateInstance(typeof(PropertyValueEntry<,>).MakeGenericType(parentType, valueType));
        ...
        public sealed override bool ApplyChanges()
        {
            ...
            if (this.Values.AreDirty)
            {
                ...
                for (int i = 0; i < this.ValueCount; i++)
                {
                    ...
                    if (object.ReferenceEquals(this.GetParent(i), null) && !(this.Property.Tree.IsStatic && this.Property.ParentValueProperty == null))
                    {
