...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class InspectorPropertyValueGetter<TReturnType>
    {
        ...
        private InspectorProperty actualProperty;
        ...
        public TReturnType GetValue()
        {
            ...
            if (this.expressionMethod != null)
            {
                ...
                {
                    return DoCast(this.expressionMethod.DynamicInvoke(this.actualProperty));
                }
                else
                {
                    return DoCast(this.expressionMethod.DynamicInvoke(this.memberProperty.ParentValues[0], this.actualProperty));
                }
            }
#endif
        ...
        public IEnumerable<TReturnType> GetValues()
        {
            ...
            if (this.expressionMethod != null)
            {
                if (this.isStaticExpression)
                {
                    yield return DoCast(this.expressionMethod.DynamicInvoke(this.actualProperty));
                }
                else
                {
                    for (int i = 0; i < this.memberProperty.ParentValues.Count; i++)
                    {
                        yield return DoCast(this.expressionMethod.DynamicInvoke(this.memberProperty.ParentValues[i], this.actualProperty));
                    }
                }
