...
namespace Sirenix.OdinInspector.Editor
{
    ...
    [ResolverPriority(-10)]
    public class TypeInfoBoxPropertyProcessor : OdinPropertyProcessor
    {
        private static readonly MemberInfo InjectedMemberInfo = typeof(TypeInfoBoxPropertyProcessor).GetMember("InjectedMember", Flags.AllMembers).First();
