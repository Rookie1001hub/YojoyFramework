...
//                    if (context.Value.MemberErrorMessage == null)
//                    {
//                        if (!attribute.ContiniousValidationCheck)
//                        {
...
//                }
//                else if (attribute.ContiniousValidationCheck && Event.current.type == EventType.Layout)
//                {
//                    RunValidation(entry, attribute, context);
//                }
...
//                this.drawer.CallNextDrawer(label);
...
//                        {
//                            if (typeof(TParent).IsValueType)
//                            {
//                                object boxedParent = entry.Property.ParentValues[i];
//                                hasError = (bool)context.Value.InstanceValidationMethodCaller.Method.Invoke(boxedParent, new object[] { entry.Values[i] }) == false;

//                                if (entry.Property.ParentValueProperty != null)
//                                {
//                                    entry.Property.ParentValueProperty.ValueEntry.WeakValues[i] = boxedParent;
//                                }
//                            }
//                            else
//                            {
...
//                            {
//                                object boxedParent = entry.Property.ParentValues[i];
//                                var args = new object[] { entry.Values[i], message };

//                                hasError = (bool)context.Value.InstanceValidationMethodCallerWithMessage.Method.Invoke(boxedParent, args) == false;
...
//                            {
//                                object boxedParent = entry.Property.ParentValues[i];
//                                var args = new object[] { entry.Values[i], message, messageType };

//                                hasError = (bool)context.Value.InstanceValidationMethodCallerWithMessageAndType.Method.Invoke(boxedParent, args) == false;
//                                message = (string)args[1];
//                                messageType = (InfoMessageType)args[2];
