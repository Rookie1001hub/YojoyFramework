...
namespace Sirenix.Utilities.Editor
{
    ...
    public sealed class ObjectPicker
    {
        ...
        {
            ShowObjectPicker(null, allowSceneObjects, buttonRect, isUnitySerialized);
        }

        /// <summary>
        /// Not yet documented.
        /// </summary>
        public void ShowObjectPicker(object currValue, bool allowSceneObjects, Rect buttonRect = default(Rect), bool isUnitySerialized = false)
        {
