...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public interface IPropertyValueEntry : IDisposable
    {
        ...
        bool ValueIsWeakList { get; }

        /// <summary>
        /// Whether the type of this entry implements <see cref="System.Collections.Generic.IList{T}"/>.
        /// </summary>
        [Obsolete("The core property system no longer has custom hard-coded collection support.", true)]
        bool ValueIsStrongList { get; }

        /// <summary>
        /// Whether the type of this entry implements <see cref="System.Collections.Generic.IDictionary{TKey, TValue}"/> and has a valid key type.
        /// </summary>
        [Obsolete("The core property system no longer has custom hard-coded collection support.", true)]
        bool ValueIsValidDictionary { get; }
        ...
        PropertyValueCategory ValueCategory { get; }
        ...
        PropertyListValueEntryChanger GetListValueEntryChanger();
        ...
        IDictionaryHandler GetDictionaryHandler();
