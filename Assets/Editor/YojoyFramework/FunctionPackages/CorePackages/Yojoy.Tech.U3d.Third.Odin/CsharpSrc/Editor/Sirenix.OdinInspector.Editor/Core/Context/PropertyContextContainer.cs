...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public sealed class PropertyContextContainer
    {
        ...
        private DoubleLookupDictionary<int, int, DoubleLookupDictionary<Type, string, object>> drawerContexts;
        ...
        private DoubleLookupDictionary<Type, string, object> GetCurrentDrawerContexts()
        {
            ...
            if (this.drawerContexts == null)
            {
                this.drawerContexts = new DoubleLookupDictionary<int, int, DoubleLookupDictionary<Type, string, object>>();
            }
