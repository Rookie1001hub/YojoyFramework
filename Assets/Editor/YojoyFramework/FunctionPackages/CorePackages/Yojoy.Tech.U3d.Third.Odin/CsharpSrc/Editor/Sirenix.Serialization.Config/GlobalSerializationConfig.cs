...
namespace Sirenix.Serialization
{
    ...
    public class GlobalSerializationConfig : GlobalConfig<GlobalSerializationConfig>
    {
        ...
        public const string ODIN_PREFAB_CAUTIONARY_WARNING_TEXT =
            ...
            "\n\n" +
            "We are currently in the process of doing an in-depth review of possible ways of implementing Odin-serialized modifications " +
            "properly with the new prefab workflow. Meanwhile, using prefabs with Odin serialization in 2018.3 and above will " +
            "be considered a *deprecated feature*." +
            "\n\n" +
            "We would like to emphasize that *our efforts may fail*. There is a real chance that we will conclude that " +
            "we simply cannot support this feature any more in the new prefab workflow, in which case it will be deprecated " +
            "*permanently*. We hope it won't come to that, but we sadly cannot promise that it won't happen. If we do " +
            "deprecate the feature, we will not remove it, but we *will* stop supporting it. You may continue using it, but " +
