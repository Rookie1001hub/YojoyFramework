...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public sealed class InspectorProperty : IDisposable
    {
        ...
        private List<BakedDrawerChain> drawerChains = new List<BakedDrawerChain>();
        ...
        ///// <summary>
        ///// Gets the type of the parent member property.
        ///// </summary>
        //public Type FindParentMemberType(bool includeSelf)
        //{
        //    if (includeSelf)
        //    {
        //        if (this.Info.HasSingleBackingMember)
        //        {
        //            return this.ParentType;
        //        }

        //        if (this.Parent == null || this.Parent == this.Tree.SecretRootProperty)
        //        {
        //            return this.ParentType;
        //        }
        //    }

        //    return this.Parent.FindParentMemberType(true);
        //}

        ///// <summary>
        ///// Gets the parent member property.
        ///// </summary>
        //public InspectorProperty FindParentMemberProperty(bool includeSelf)
        //{
        //    if (includeSelf)
        //    {
        //        if (this.Info.HasSingleBackingMember)
        ...
        //    return this.Parent.FindParentMemberProperty(true);
        //}
        ...
        public void Draw(GUIContent defaultLabel)
        {
            ...
            try
            {
                ...
                {
                    if ((this.ParentValueProperty == null || this.ParentValueProperty.SupportsPrefabModifications) && GeneralDrawerConfig.Instance.ShowPrefabModificationsDisabledMessage)
                    {
...

                {
                    try
                    {
                        if (chain.MoveNext())
                        {
                            ...
                            if (setIsBoldState)
                            {
                                var boldState = this.ValueEntry.ValueChangedFromPrefab;
                            ...
                            var popPushGUIEnabled = this.ValueEntry != null && !this.ValueEntry.IsEditable;
        ...
        public bool IsReachableFromRoot()
        {
            ...
            try
            {
                if (this.Parent == null)
                {
                    var root = this.Tree.SecretRootProperty;
            ...
            finally
            {
                ...
                {
                    Debug.Log(this.Path + " WAS NOT REACHABLE");
                }
            }
        }
        ...
        /// </summary>
        [Obsolete("The concept of a PropertyValueCategory is obsolete, as the notion of a value category is no longer robust in the new 1.1 property system.", true)]
        ...
        public bool Update(bool forceUpdate = false)
        {
            ...
            if (this.Children == null || this.ChildResolver == null || (this.ValueEntry != null && this.ChildResolver.ResolverForType != null && this.ValueEntry.TypeOfValue != this.ChildResolver.ResolverForType))
            {
                this.RefreshSetup();
            }
            else
