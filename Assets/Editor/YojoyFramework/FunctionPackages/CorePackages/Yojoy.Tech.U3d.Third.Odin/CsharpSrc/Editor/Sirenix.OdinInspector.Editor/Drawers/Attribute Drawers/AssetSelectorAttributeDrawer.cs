    ...
    public sealed class AssetSelectorAttributeDrawer : OdinAttributeDrawer<AssetSelectorAttribute>
    {
        ...
        protected override void Initialize()
        {
            ...
            this.getValues = () =>
            {
                ...
                // TODO: Bjarke, this was unused by it looks it should be used underneath. Take a look when you have time.
                //var typeToSearchFor = this.elementOrBaseType == typeof(string) ? typeof(UnityEngine.Object) : this.elementOrBaseType;
