...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class OdinMenuItem
    {
        ...
        public Action<OdinMenuItem> OnLeftClick;
        ...
        public virtual string SmartName
        {
            get
            {
                ...
                else if (this.nameValueGetter != null && val != null && this.nameValueGetter.ObjectType != val.GetType())
                {
                    makeNewGetter = true;
                }
                ...
                if (this.nameValueGetter != null)
                {
                    return this.nameValueGetter.ForceGetString(val);
                }
                else
                {
                    return this.name;
        ...
        private static int mouseDownClickCount; // Click-count is 2 in mouseDown, but 1 in mouse-up.
