...
namespace Sirenix.Utilities.Editor.Expressions
{
    ...
    #region Utilities
        ...
        private ASTNode GetUnaryOperatorPrecedence(ASTNode @operator, ASTNode operand)
        {
            ...
            if (operand.Children.Count != 2) throw new InvalidOperationException("Manual precedence operator AST Node did not have two children during precedence resolution - how'd this happen?");
