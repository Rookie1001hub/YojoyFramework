    ...
    public static class TypeExtensions
    {
        ...
        public static Type[] GetArgumentsOfInheritedOpenGenericInterface(this Type candidateType, Type openGenericInterfaceType)
        {
            ...
            else
            {
                ...
                // Special case; in some versions of Unity when on .NET 4.6, we need this hardcoded to make sure that enum arrays are not thought of
                // as being lists of ints.
                if (candidateType.IsArray && candidateType.GetArrayRank() == 1 && candidateType.GetElementType().IsEnum && openGenericInterfaceType == typeof(IList<>))
                {
