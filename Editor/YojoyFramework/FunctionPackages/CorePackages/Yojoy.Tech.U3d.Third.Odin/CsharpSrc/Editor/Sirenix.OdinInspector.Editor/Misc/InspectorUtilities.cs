...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class InspectorUtilities
    {
        ...
        {
            tree.prevTimeHelper = EditorTimeHelper.Time;
            EditorTimeHelper.Time = tree.timeHelper;
            ...
            {
                var scriptProp = tree.SecretRootProperty.Context.GetGlobal("m_Script", (SerializedPropertyContainer)null);

                if (scriptProp.Value == null)
                {
                    scriptProp.Value = new SerializedPropertyContainer()
                    {
                        SerializedProperty = tree.UnitySerializedObject.FindProperty("m_Script")
                    };
                }

                if (scriptProp.Value.SerializedProperty != null)
                {
                    GUIHelper.PushGUIEnabled(false);
                    EditorGUILayout.PropertyField(scriptProp.Value.SerializedProperty);
