...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class OdinMenuTreeExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<OdinMenuItem> SortMenuItemsByName(this IEnumerable<OdinMenuItem> menuItems, bool placeFoldersFirst = true)
        {
            ...
            var q = menuItems.ForEach(x => x.ChildMenuItems.Sort(comparer));
