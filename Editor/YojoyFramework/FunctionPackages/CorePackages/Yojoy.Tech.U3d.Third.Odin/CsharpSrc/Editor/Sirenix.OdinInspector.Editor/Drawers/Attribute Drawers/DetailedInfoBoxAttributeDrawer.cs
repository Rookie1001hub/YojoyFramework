                    ...
                    try
                    {
                        ...
                        if (entry != null)
                        {
                            ...
                            this.drawMessageBox =
                                ...
                                (this.instanceValidationParameterMethodCaller != null && this.instanceValidationParameterMethodCaller(parentValue, entry.WeakSmartValue)) ||
                                (this.instanceValidationMethodCaller != null && this.instanceValidationMethodCaller(parentValue)) ||
