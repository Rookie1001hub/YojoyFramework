...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class ProcessedMemberPropertyResolverExtensions
    {
        ...
        public static void AddDelegate(this IList<InspectorPropertyInfo> infos, string name, Action @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1>(this IList<InspectorPropertyInfo> infos, string name, Action<T1> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, T2>(this IList<InspectorPropertyInfo> infos, string name, Action<T1, T2> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, T2, T3>(this IList<InspectorPropertyInfo> infos, string name, Action<T1, T2, T3> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, T2, T3, T4>(this IList<InspectorPropertyInfo> infos, string name, Action<T1, T2, T3, T4> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<TResult>(this IList<InspectorPropertyInfo> infos, string name, Func<TResult> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, TResult>(this IList<InspectorPropertyInfo> infos, string name, Func<T1, TResult> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, T2, TResult>(this IList<InspectorPropertyInfo> infos, string name, Func<T1, T2, TResult> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, T2, T3, TResult>(this IList<InspectorPropertyInfo> infos, string name, Func<T1, T2, T3, TResult> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate<T1, T2, T3, T4, TResult>(this IList<InspectorPropertyInfo> infos, string name, Func<T1, T2, T3, T4, TResult> @delegate, int order = 0, params Attribute[] attributes)
        {
            AddDelegate(infos, name, (Delegate)@delegate, order, attributes);
        }

        public static void AddDelegate(this IList<InspectorPropertyInfo> infos, string name, Delegate @delegate, int order = 0, params Attribute[] attributes)
        {
