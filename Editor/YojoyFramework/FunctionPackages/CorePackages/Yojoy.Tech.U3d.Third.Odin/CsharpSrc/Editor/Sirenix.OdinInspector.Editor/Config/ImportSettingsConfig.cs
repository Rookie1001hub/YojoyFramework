...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class ImportSettingsConfig : GlobalConfig<ImportSettingsConfig>
    {
        ...
        private OdinAssemblyOptions AssemblyBuildConfiguration { get { return this.currentOption; } set { this.currentOption = value; } }
        ...
        private void Apply()
        {
            EditorApplication.delayCall += this.ApplyDelayed;
        }
        ...
        private enum OdinAssemblyOptions
        {
            Recommended = 0,
            AOT = 1,
            JIT = 2,
