...
namespace Sirenix.OdinInspector
{
    ...
    public class HorizontalGroupAttribute : PropertyGroupAttribute
    {
        ...
        public HorizontalGroupAttribute(string group, float width = 0, int marginLeft = 0, int marginRight = 0, int order = 0)
            : base(group, order)
        {
            this.Width = width;
        ...
        /// <param name="marginRight">The right margin in pixels.</param>
        /// <param name="order">The order of the group in the inspector.</param>
        public HorizontalGroupAttribute(float width = 0, int marginLeft = 0, int marginRight = 0, int order = 0)
